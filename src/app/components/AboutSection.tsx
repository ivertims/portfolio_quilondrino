    ...
    <section id="about" className="mb-20 scroll-mt-24">
      <div className="flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="relative group flex-shrink-0 w-full md:w-64">
          <div 
            className="w-full aspect-[3/4] overflow-hidden shadow-lg transition-transform duration-300 group-hover:scale-105 cursor-pointer border border-slate-200 dark:border-slate-700"
        ...
        <div className="flex-1">
          ...
          <p className="text-base text-slate-600 dark:text-slate-300 leading-relaxed">
            With a solid track record in data science, I've collaborated with prestigious research institutes like the <a href="https://www.urios.edu.ph/" target="_blank" rel="noopener noreferrer" className="text-[#1e3a5f] dark:text-[#5a7fa8] hover:underline">Father Saturnino Urios University</a> and leading private companies.
          </p>
        </div>
      </div>
    </section>
